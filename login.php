						...
						<div class="account-wrapper">
							...
							<form method="POST" enctype="multipart/form-data">
								...
								<div class="account-footer">
									<p>Having Trouble? report an issue on github <a target="https://github.com/mushlihun/hrpayroll.git/issues" href="https://github.com/mushlihun/hrpayroll.git/issues">Github issues</a></p>
								</div>
							</form>
							<!-- /Account Form -->
